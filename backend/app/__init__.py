"""
MegaFish Backend - Flask Application Factory
"""
...
def create_app(config_class=Config):
    ...
    @app.route('/health')
    def health():
        return {'status': 'ok', 'service': 'MegaFish Backend'}

    if should_log_startup:
        logger.info("MegaFish Backend startup complete")
